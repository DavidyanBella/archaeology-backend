...
class Place(models.Model):
    ...
    image = models.ImageField(upload_to="places", default="places/default.jpg", verbose_name="Фото")
...
class Find(models.Model):
    ...
    expedition_date = models.DateField(verbose_name="Дата экспедиции", blank=True, null=True)

    name = models.CharField(max_length=100, verbose_name="Название", blank=True)
    description = models.TextField(max_length=500, verbose_name="Описание", blank=True)
    expedition = models.CharField(max_length=100, verbose_name="Экспедиция", blank=True)

    places = models.ManyToManyField(Place, verbose_name="Находки", null=True)
