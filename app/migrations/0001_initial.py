# Generated by Django 4.2.5 on 2024-01-30 21:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='places/default.png', upload_to='places', verbose_name='Фото')),
            ],
            options={
                'verbose_name': 'Места',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=100, verbose_name='Название')),
                ('description', models.TextField(blank=True, max_length=500, verbose_name='Описание')),
                ('expedition', models.CharField(blank=True, max_length=100, verbose_name='Экспедиция')),
                ('status', models.IntegerField(choices=[(1, 'Введён'), (2, 'В работе'), (3, 'Завершен'), (4, 'Отклонен'), (5, 'Удален')], default=1, verbose_name='Статус')),
                ('date_created', models.DateTimeField(default=datetime.datetime(2024, 1, 30, 21, 29, 27, 526991, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ...
                ('places', models.ManyToManyField(null=True, to='app.place', verbose_name='Продукты')),
            ],
            options={
                'verbose_name': 'Заявка',
